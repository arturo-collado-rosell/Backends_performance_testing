...
def plot_latency(flask_latency, sanic_latency, express_latency,  d_i = None, c_i = None, w_i = None):
...
def plot_requests(flask_requests, sanic_requests, express_requests,  d_i = None, c_i = None, w_i = None):
    if d_i == None and c_i!= None and w_i!= None:
        x = []
        y_flask = []
        y_sanic = []
...
def plot_errors(flask_errors, sanic_errors, express_errors,  d_i = None, c_i = None, w_i = None):
    if d_i == None and c_i!= None and w_i!= None:
        x = []
        y_flask = []
        y_sanic = []
...
def plot_info_2d(data, d_i = None, c_i = None, w_i = None):
    ...
    plot_latency(flask_latency, sanic_latency, express_latency, d_i, c_i, w_i)
    plot_requests(flask_requests, sanic_requests, express_requests, d_i, c_i, w_i)  
    plot_errors(flask_errors, sanic_errors, express_errors, d_i, c_i, w_i)
...
if __name__ == '__main__':
    ...
    plot_info_2d(data,d_i = 30, c_i = None, w_i = 0)       
